		...
		<table class="form-table">
			<tbody>
				<tr class="row-area-kota">
					...
					<td>
						<?php /*<input type="text" name="area_kota" id="area_kota" class="regular-text" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />*/ ?>
						<select name="area_kota" id="area_kota" class="regular-text" required="required">
				...
				<tr class="row-kode-pos">
					...
					<td>
						<input type="text" name="kode_pos" id="kode_pos" class="regular-text" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
				...
				<tr class="row-kelurahan">
					...
					<td>
						<input type="text" name="kelurahan" id="kelurahan" class="regular-text" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
					</td>
				</tr>
				<tr class="row-jalan">
					<th scope="row">
					...
					<td>
						<input type="text" name="jalan" id="jalan" class="regular-text" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
				...
				<tr class="row-nama-lengkap">
					...
					<td>
						<input type="text" name="nama_lengkap" id="nama_lengkap" class="regular-text sambunganbaru-field" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
					</td>
				</tr>
				<tr class="row-alamat-lengkap">
					...
					<td>
						<textarea name="alamat_lengkap" id="alamat_lengkap" class="sambunganbaru-field" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" rows="5" cols="30" required="required" disabled="disabled"></textarea>
					</td>
				</tr>
				<tr class="row-rt-rw">
					<th scope="row">
				...
				<tr class="row-luas-bangunan">
					...
					<td>
						<input type="number" name="luas_bangunan" id="luas_bangunan" class="regular-text sambunganbaru-field" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
					</td>
				</tr>
				<tr class="row-jumlah-penghuni">
					...
					<td>
						<input type="number" name="jumlah_penghuni" id="jumlah_penghuni" class="regular-text sambunganbaru-field" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
					</td>
				</tr>
				<tr class="row-telepon">
					...
					<td>
						<input type="text" name="telepon" id="telepon" class="regular-text sambunganbaru-field" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
					</td>
				</tr>
				<tr class="row-telepon-genggam">
					...
					<td>
						<input type="text" name="telepon_genggam" id="telepon_genggam" class="regular-text sambunganbaru-field" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
					</td>
				</tr>
				<tr class="row-email">
					<th scope="row">
				...
				<tr class="row-fungsi-bangunan">
					...
					<td>
						<input type="text" name="fungsi_bangunan" id="fungsi_bangunan" class="regular-text sambunganbaru-field" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="" disabled="disabled" required="required" />
					</td>
				</tr>
			 </tbody>
		</table>
